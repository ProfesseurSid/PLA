...
public class Mate extends Parent {
	...
	public Mate(int X, int Y, int equipe) {
		...
		ImageView robB = new ImageView(new Image(PersonnagesVisual.class.getResourceAsStream("images/TeteRobotBleu.png")));
		robB.setFitWidth(taille);
		robB.setFitHeight(taille);
		ImageView robR = new ImageView(new Image(PersonnagesVisual.class.getResourceAsStream("images/TeteRobotRouge.png")));
